  ...
  const selectedFile = e => {
    ...
    return (
        <div className='center'>
            <h3 className='gap-bottom'>Add A Tour Package</h3>
            <form className='flex-section' onSubmit={handleSubmit(onSubmit)}>
                <input placeholder='Tour Package Name' {...register("name", { required: true })} />
                {errors.name && <span className='error'>This field is required</span>}
                <input placeholder='Package Cost' {...register("price", { required: true })} />
                {errors.price && <span className='error'>This field is required</span>}
                <input placeholder='package-duration' {...register("duration", { required: true })} />
                {errors.duration && <span className='error'>This field is required</span>}     
